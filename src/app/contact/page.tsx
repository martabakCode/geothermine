      ...
      <div className="flex flex-col min-h-screen mt-10">
                ...
                <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <p className="mt-2 text-sm text-yellow-500 dark:text-yellow-400">geothermine.hub@gmail.com</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-yellow-500 dark:text-yellow-400">Tembalang Semarang</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Monday - Friday: 9:00 AM - 6:00 PM</p>
                            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Saturday: 10:00 AM - 4:00 PM</p>
                            <p className="mt-2 text-sm text-yellow-500 dark:text-yellow-400">+62 (822) 417-48308</p>
                        </div>
                    </div>
        ...
        <section className="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-16">
            <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                ...
                <a href="https://www.instagram.com/geothermine.id/" className="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                ...
                <a href="https://wa.me/6282241748308" className="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    <svg className="me-2 h-4 w-4 shrink-0 text-gray-900 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
